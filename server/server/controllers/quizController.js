...
//     // Handle Dynamic Quiz (already working as expected)
//     if (quizType === "dynamic") {
//       // If it's a dynamic quiz, no changes needed, just save the dynamic quiz
//       const quiz = await Quiz.create({
//         University,
//         Subject_code,
//         category,
...
//     // Handle Static Quiz - Manual Entry
//     if (quizType === "static") {
//       // If it's a static quiz, we need to handle two options: file upload or manual entry

//       // Handle Manual Entry
//       if (uploadOption === "manual" && staticQuestion && staticAnswer) {
//         const formattedQuestions = [
//           {
//             questionText: staticQuestion,
//             options: [
//               { optionText: staticAnswer, isCorrect: true }, // Mark the answer option as correct
//             ],
//           },
//         ];

//         // Save the static quiz with manually entered questions
//         const quiz = await Quiz.create({
//           University,
//           Subject_code,
//           category,
//           questions: formattedQuestions, // Save the formatted questions
//         });
...
//       // Handle File Upload from Memory (no file saved to disk)
...
//         const workbook = xlsx.read(fileBuffer, { type: "buffer" }); // Use the buffer directly
//         const sheet = workbook.Sheets[workbook.SheetNames[0]];
//         const data = xlsx.utils.sheet_to_json(sheet);

//         // Format the questions extracted from the file
//         const questionsFromFile = data.map((row) => ({
//           questionText: row.question,
//           options: [
//             { optionText: row.answer, isCorrect: true }, // Assuming the answer column contains the correct answer
//           ],
//         }));

//         // Save the quiz with questions from the uploaded file
//         const quiz = await Quiz.create({
//           University,
//           Subject_code,
//           category,
//           questions: questionsFromFile, // Save the questions extracted from the file
//         });
...
//       // If neither manual nor file upload is provided, send a 400 error
//       return res.status(400).json({
//         success: false,
//         message: "Please provide a valid option (file or manual).",
//       });
//     }

//     // If quizType is not 'dynamic' or 'static', send an error
//     return res.status(400).json({
//       success: false,
//       message: "Invalid quiz type. Please select either dynamic or static.",
//     });
//   } catch (error) {
//     res.status(500).json({
//       success: false,
